...
top.bar(gme.index, gme['high'], color='cornflowerblue')
bottom.bar(gme.index, gme['volume'], color='cornflowerblue')

top.axes.get_xaxis().set_visible(False)
top.set_title('GME Share Price Analysis')
top.set_ylabel('Highest Price')
bottom.set_ylabel('Volume')

plt.show()

fig1.savefig('graphs/gme_full_sp_vol.png')
...
fig2.savefig('graphs/gme_volume.png')
